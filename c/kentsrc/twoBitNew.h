...
/* specification for a seq or subsequence in a .2bit file */
{
    ...
    char *bedName;             /* BED6 Support BED:name field ( not to be confused with "chrom" ) - unused by most */
    char *score;               /* BED6 Support BED:score field - unused by most */
    char *strand;              /* BED6 Support BED:strand field - unused by most */
};
