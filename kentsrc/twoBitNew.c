...
// RMH
static struct twoBitFile *getTbfAndOpen(char *fileName)
{
...
if (tbf->bpt)
    {
     errAbort("bpt format is not supported in this version of the library");
    }
else
    {
...
struct twoBitFile *tbf = getTbfAndOpen(fileName);
boolean isSwapped;
